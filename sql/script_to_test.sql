delete from music.bands_events where id_band = md5(lower(regexp_replace('Asomwel', '\s|\W', '', 'g')));
delete from music.bands_events where id_event = md5(lower(regexp_replace('Asomwel, Warfield', '\s|\W', '', 'g')));
...
delete from music.events where id_event = md5(lower(regexp_replace('Asomwel, Warfield', '\s|\W', '', 'g')));
delete from geo.places where id_place = md5(lower(regexp_replace('Test Place', '\s|\W', '', 'g')));
delete from music.bands where id_band = md5(lower(regexp_replace('Asomwel', '\s|\W', '', 'g')));
